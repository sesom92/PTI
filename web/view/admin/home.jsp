...
<html>
    ...
    <body>
        ...
        <table width="100%" border="0" align="center" bgcolor="#FFFFFF">
            <tr >
                <td colspan="3"> <marquee direction="left" scrollamount="6" style="font-size:14px; 
                                          background:#FFFFFF; color:#3399ff">
                                    <strong>Selamat Datang di Smart Office UKM</strong></marquee>
                </td>
            </tr>
        </table>
           ...
           <h1><img src="../../img/hehe1.png"></h1>
            ...
            <div class="container-fluid">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="manipulasievent.jsp">Event Tidak Wajib</a></li>
                </ul>
